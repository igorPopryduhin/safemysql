...
class SafeMySQL
{
    ...
    protected $emode;
    protected $exname;
    protected $defaults = array('host' => 'localhost', 'user' => 'root', 'pass' => '', 'db' => 'basic_cms', 'port' => NULL, 'socket' => NULL, 'pconnect' => FALSE, 'charset' => 'utf8', 'errmode' => 'exception', //or 'error'
     ...
     *
     * @return mysqli whatever mysqli_query returns
     */
    ...
    {
        return mysqli_sqlstate($this->conn);
    }
